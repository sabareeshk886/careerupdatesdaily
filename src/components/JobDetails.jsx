    ...
    <>
        ...
        <div style={{ display: 'grid', gap: '2.5rem' }}>
            <section>
                ...
                <div style={{ lineHeight: '1.75', color: 'var(--text-secondary)', whiteSpace: 'pre-wrap', fontSize: '1rem' }}>
            ...
            <section style={{
                ...
                <div>
                    ...
                    <span style={{ fontSize: '1.25rem', fontWeight: '600', color: 'var(--text-primary)' }}>{job.salary}</span>
                </div>
                <a
                    href={job.applyUrl}
                    target="_blank"
